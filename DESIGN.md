...
### Don't
- Don't introduce additional accent colors beyond `{colors.accent-lime}` and `{colors.accent-pink}` — adding teal or yellow dilutes the violet-and-lime signature.
